...
QVariantList defaultShortcutBindings()
{
    return {
        ...
        shortcutMap(QStringLiteral("SUPER"), QStringLiteral("T"), QStringLiteral("tide"), QStringLiteral("showTimer")),
        ...
        shortcutMap(QStringLiteral("SUPER"), QStringLiteral("P"), QStringLiteral("tide"), QStringLiteral("togglePowerMenu")),
